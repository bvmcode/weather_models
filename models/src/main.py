...
def main(model_run, hour, local_run, date):
    ...
    mb850.generate_rh_image(hour, filepath, date, model_run, local_run)
    mb850.generate_dew_point_image(hour, filepath, date, model_run, local_run)
    upper_level.generate_height_and_wind_images(hour, filepath, date, model_run, local_run)
